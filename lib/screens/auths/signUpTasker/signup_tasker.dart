...
import 'package:taskhub/screens/auths/signUpTasker/signup_tasker2.dart';
...
class SignUpTasker extends StatefulWidget {
  ...
  @override
  _SignUpTaskerState createState() => _SignUpTaskerState();
}

class _SignUpTaskerState extends State<SignUpTasker> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              PrimaryButton(label: "Proceed", onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => SignupTasker2()),
                );
              }),
